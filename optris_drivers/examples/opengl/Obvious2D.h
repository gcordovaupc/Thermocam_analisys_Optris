...
#define TEXTMAX 10
  ...
  public:
    ...
    /**
     * Clear info texts previously added (will not be displayed at next drawing)
     */
    void clearVolatileInfoText();

    /**
     * Set color of canvas (info text field)
     * @param color defition as rgba array
     */
    void setColorCanvas(unsigned char color[4]);
